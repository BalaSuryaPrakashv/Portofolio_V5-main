...
const AboutPage = () => {
  ...
  const statsData = useMemo(() => [
    {
      ...
      description: "Data & AI solutions crafted",
  ...
  return (
    // ✅ FIX 1: removed "mt-10 sm:mt-0" to eliminate top gap
    <div
      className="h-auto pb-6 text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]"
      id="About"
    >
      <Header />

      {/* ✅ FIX 2: reduced pt-8 sm:pt-12 → pt-4 sm:pt-6 to tighten spacing */}
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
              I'm a final-year student at Akshaya College of Engineering and Technology, passionate about{" "}
              <b>Data Analytics</b>, Machine Learning, and turning raw data into actionable insights.
              I have worked on projects like <b>Third Vision</b>, an AI-powered assistive system where I
              optimized model performance and analyzed real-time data pipelines, and completed a{" "}
              <b>Data Analyst internship</b> involving data cleaning, EDA, and ML model evaluation.
              I'm proficient in <b>Python, SQL, Pandas, and Power BI</b>, with a strong foundation in
              statistical analysis and data visualization.
              Apart from coding, I enjoy finding patterns in complex datasets and building solutions
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1nS44QP5Y1Vbz9NXR87sJS60SXLmTKdUW/view?usp=sharing" className="w-full lg:w-auto">
                <button 
                  data-aos="fade-up"
                  data-aos-duration="800"
