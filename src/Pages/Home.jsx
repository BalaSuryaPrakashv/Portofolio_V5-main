...
const SOCIAL_LINKS = [
  ...
  { icon: Mail, link: "https://mail.google.com/mail/u/0/" }
];
...
const Home = () => {
  ...
  return (
    <div className="bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%]" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto">
          {/* ✅ FIX: reduced top padding to bring content closer to navbar */}
          <div className="flex flex-col lg:flex-row items-center justify-between pt-8 pb-0 lg:pt-10 lg:pb-0 gap-10 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-lg text-gray-300 mt-4">
                  Aspiring <span className="text-blue-400">Data Analyst</span> with skills in
                  data visualization, machine learning, and analytics.
                </p>
