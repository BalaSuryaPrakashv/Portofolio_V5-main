  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...selectedProject,
        TechStack: selectedProject.Technologies || selectedProject.TechStack || [],
        Features: selectedProject.Features || selectedProject.features || [],
        Github: selectedProject.Github || 'https://github.com/BalaSuryaPrakashv',
        // Resolve demo URL: prefer Link, fall back to Demo column
        demoUrl: selectedProject.Link ||
          (selectedProject.Demo && selectedProject.Demo !== 'Demo Not Available'
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {project.demoUrl ? (
                  ...
                  <span className="inline-flex items-center space-x-1.5 md:space-x-2 px-4 md:px-8 py-2.5 md:py-4 text-gray-500 rounded-xl border border-white/5 text-sm md:text-base cursor-not-allowed">
                    <ExternalLink className="w-4 h-4 md:w-5 md:h-5" />
                    <span className="font-medium">Demo Not Available</span>
                  </span>
                )}
